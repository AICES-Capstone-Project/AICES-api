...
//         [HttpGet("job/{jobId}/excel")]
//         [Authorize(Roles = "HR_Manager, HR_Recruiter")]
//         public async Task<IActionResult> ExportJobCandidatesToExcel(int jobId)
//         {
//             var serviceResponse = await _reportService.ExportJobCandidatesToExcelAsync(jobId);
